...
window.addEventListener('load', () => {
  ...
  editModeButton.addEventListener('click', () => {
    editModeButton.classList.toggle('primary');
    const isActive = editModeButton.classList.contains('primary');
    ...
    if (savedState) {
        ...
        Object.keys(state).forEach((id) => {
            if (id === 'descriptionMode') {
                ...
                const descriptionModeButton = document.getElementById('descriptionMode');
                descriptionModeButton.classList.toggle('primary', !descriptionMode); // Reversed logic here
                initializeDescriptionMode();
            } else {
...
function resetAllValues() {
  ...
  const editModeButton = document.getElementById('editMode');
  if (editModeButton.classList.contains('primary')) {
...
function toggleValue(id) {
  ...
  const editMode = document.getElementById('editMode').classList.contains('primary');
...
function toggleDescriptionMode() {
  ...
  // Toggle the active class on the button (reversed logic)
  descriptionModeButton.classList.toggle('primary', !descriptionMode);
...
function initializeDescriptionMode() {
  ...
  // Set initial button state (reversed logic)
  descriptionModeButton.classList.toggle('primary', !descriptionMode);
}
...
// Debugging
console.log('talents.js loaded and executed');
document.addEventListener('DOMContentLoaded', () => {
  console.log('DOM fully loaded');
  console.log('Number of .grid-item elements:', document.querySelectorAll('.grid-item').length);
  console.log('Edit mode button:', document.getElementById('editMode'));
  console.log('Description mode button:', document.getElementById('descriptionMode'));
